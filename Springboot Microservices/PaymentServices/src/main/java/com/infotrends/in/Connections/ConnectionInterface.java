package com.infotrends.in.Connections;
...
public class ConnectionInterface {
    ...
    public HashMap<String, Object> executes(String urlStr,JSONObject jsonRequest, String httpMethod, String needRazorPayAuth) {
        HashMap<String, Object> ResponseMap = new HashMap<String, Object>();
        try {
            URL url = new URL(urlStr);
            ...
            conn.setRequestProperty("Content-Type", "application/json");
            conn.setRequestProperty("Accept", "*/*");
            if(needRazorPayAuth.equalsIgnoreCase("Y")) {
	            String encoded = Base64.getEncoder().encodeToString(("rzp_test_1OnHyQf62f3JNR"+":"+"iYXMef9vScvWtLemApt8sjRs").getBytes(StandardCharsets.UTF_8));  //Java 8
